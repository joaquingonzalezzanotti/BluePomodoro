...
import { Settings, Music, Cloud, ExternalLink, Save, Calendar, CheckSquare } from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-700">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Gestiona tus integraciones y ecosistema de trabajo.</p>
        </div>
      </div>
      ...
      <div className="p-8 bg-slate-900 text-white rounded-[2rem] flex items-center justify-between">
        <div className="space-y-2">
          <h3 className="text-lg font-black flex items-center gap-2"><Cloud className="h-5 w-5 text-primary" /> Estado Cloud</h3>
          <p className="text-sm text-slate-400">Tu cuenta está sincronizada con Firebase y lista para usar IA.</p>
        </div>
